...
//  MARK: For chat context
  ...
  static var preview3 = UIRecipeModel(id: UUID(), name: "Sweet Soup Borsch",time: 35, difficulty: 2,timesCooked: 0, description: "A cozy and flavorful one-pan dish with tender chicken, golden potatoes, and aromatic herbs in a creamy sauce", macros: "-420, 12, 25, 12", cookingTip: "QWe qwe eqweqwm wqmekqw kmwqelq qwkm", ingredients: ["asdasd", "dqwd", "qwdqwd", "qdwqd", "qwdqwd"], instructions: [], isFavorite: false, imageUrl: "https://images.pexels.com/photos/5436476/pexels-photo-5436476.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", chatHistory: [], dateCreated: Date.distantPast, isRecommended: true, recommendedDate: .distantPast)
}
